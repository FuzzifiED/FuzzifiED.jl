...
\extra{\textit{Documentation}~: \url{https://docs.fuzzified.world}\\\textit{Source code}~: \url{https://github.com/FuzzifiED/FuzzifiED.jl}\\\textit{Version}~: 1.0.3}
...
Having constructed the configurations, we now construct the basis of the Hilbert space. The `\emph{basis}' is the collection of states that are linear combinations of the configurations carrying certain diagonal and $\mathbb{Z}_p$ off-diagonal quantum numbers (QNOffd).
...
\begin{enumerate}
    ...
    \item \linkexample{defect\_spectrum.jl} calculates the spectrum of magnetic line defect in the 3d Ising model in $l_z=0,\mathcal{P}=\pm 1$ and $l_z = 1$ sectors, calibrated by bulk $T$. This example reproduces Table~I in Ref.~\cite{Hu2023Aug}.
    ...
    \item \linkexample{so5\_spectrum.jl} calculates the spectrum of $\mathrm{SO}(5)$ DQCP on the fuzzy sphere. This example reproduces Table~II in Ref.~\cite{Zhou2023}.
    \item \linkexample{sp3\_spectrum.jl} calculates the spectrum of $\mathrm{Sp}(3)$ CFT on the fuzzy sphere. This example reproduces Table~I in Ref.~\cite{Zhou2024Oct}.
    ...
    \item \linkexample{potts\_spectrum.jl} calculates the spectrum of 3d Potts model on the fuzzy sphere. This example reproduces Table I and Figure 4 in Ref.~\cite{Yang2025}.
    ...
    \item \linkexample{yang\_lee\_spectrum.jl} calculates the spectrum of 3d non-unitary Yang-Lee CFT on fuzzy sphere. This example reproduces Figure 3c in Ref.~\cite{Fan2025}.
