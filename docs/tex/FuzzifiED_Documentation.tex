...
This seminal work opens a new avenue for studying 3D conformal field theories. After that, most of the research on the fuzzy sphere can roughly be categorised into three directions~:
...
The second direction is to study various other CFTs beyond 3D Ising. The fuzzy sphere has revealed lots of new information about these theories~; the previously known results are also consistent with the fuzzy sphere. So far, the accessible CFTs include $\SO(5)$ deconfined criticality~\cite{Zhou2023}, $\rO(3)$ Wilson-Fisher~\cite{Han2023Dec}, a series of new theories with $\Sp(N)$ symmetry~\cite{Zhou2024Oct}, the 3-state Potts model~\cite{Yang2025Jan}, the free scalar CFT~\cite{He2025Jun,Taylor2025} and the $\rO(4)$ deconfined criticality~\cite{Yang2025Jul}. An outstanding catagory is to realise CFTs through fractional quantum Hall transitions. We leave the discussion to the next section. 
...
This work studies one of the simplest instances of Chern-Simons-matter theories~: one complex critical scalar coupled to a $\rU(1)_2$ Chern-Simons gauge field and its three other dual Lagrangian descriptions. They describe the transition between a $\nu=1/2$ bosonic Laughlin state and a trivially gapped phase. This transition appears in various contexts in condensed~matter physics, \textit{viz.}~Kalmeyer-Laughlin chiral spin liquid, anyon superconductivity, Feshbach resonance, \textit{etc.}
...
\begin{enumerate}
    ...
    \item \linkexample{yang\_lee\_spectrum.jl} calculates the spectrum of 3D non-unitary Yang-Lee CFT on fuzzy sphere. This example reproduces Figure 11 in Ref.~\cite{ArguelloCruz2025}.
    ...
    \item \linkexample{o4\_dqcp\_spectrum.jl} calculates the spectrum of $\rO(4)$ DQCP on fuzzy sphere. This example reproduces Figure 4 and Table I in Ref.~\cite{Yang2025Jul}.
...
\begin{multicols}{2}
    ...
    \href{https://docs.fuzzified.world/core/\#FuzzifiED.ObsNormRadSq}{\lstinline|FuzzifiED.ObsNormRadSq|}\\
