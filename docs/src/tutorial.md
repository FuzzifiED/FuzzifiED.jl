...
* [`hsb_2l_sp
ectrum.jl`](https://github.com/FuzzifiED/FuzzifiED.jl/blob/main/examples/hsb_2l_sp
ectrum.jl) calculates the spectrum of ``\mathrm{O}(3)`` Wilson-Fisher CFT using the bilayer Heisenberg model. This example reproduces Table I and Figure 2 in [Han 2023Dec](@ref Han2023Dec).
