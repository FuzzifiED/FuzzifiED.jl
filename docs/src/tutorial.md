...
* [`free_real_scalar_spectrum.jl`](https://github.com/FuzzifiED/FuzzifiED.jl/blob/main/examples/free_real_scalar_spectrum.jl) calculates the spectrum of free real scalar. This example reproduces Figure 2 in [He 2025Jun](@ref He2025Jun)
