...
* [`yang_lee_spectrum.jl`](https://github.com/FuzzifiED/FuzzifiED.jl/blob/main/examples/yang_lee_spectrum.jl) calculates the spectrum of 3d non-unitary Yang-Lee CFT on
fuzzy sphere. This example reproduces Figure 3c in [Fan 2025](@ref Fan2025)
